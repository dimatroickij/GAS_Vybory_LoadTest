# 1 "f:\\gas_vybory\\lr_scripts\\workwithsections\\\\combined_WorkWithSections.c"
...
# 1 "f:\\gas_vybory\\lr_scripts\\workwithsections\\\\combined_WorkWithSections.c" 2
...
# 2 "f:\\gas_vybory\\lr_scripts\\workwithsections\\\\combined_WorkWithSections.c" 2
...
# 3 "f:\\gas_vybory\\lr_scripts\\workwithsections\\\\combined_WorkWithSections.c" 2
...
vuser_init()
{
	...
	web_url("auth_2", 
		"URL=http://{urlLogin}/realms/test/protocol/openid-connect/auth?client_id=ruiptest&redirect_uri=http%3A%2F%2F{URL}&response_type=id_token%20token&scope=openid%20email%20profile&nonce=8c87695faa570d668414c7060aa6f4a4d4MX6dtK&state=977b67dce2191432f19d19765ae4ad7deBzevOCl", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=http://{URL}/", 
		"Snapshot=t4.inf", 
	...
	lr_output_message(lr_eval_string("{state}"));
...
# 4 "f:\\gas_vybory\\lr_scripts\\workwithsections\\\\combined_WorkWithSections.c" 2

# 1 "WorkWithsectionsAction.c" 1
WorkWithsectionsAction()
{
	...
	lr_end_transaction("OpeningPage", 2);
...
# 5 "f:\\gas_vybory\\lr_scripts\\workwithsections\\\\combined_WorkWithSections.c" 2
...
# 6 "f:\\gas_vybory\\lr_scripts\\workwithsections\\\\combined_WorkWithSections.c" 2
